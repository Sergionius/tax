...
Please report vulnerabilities privately through GitHub Security Advisories ("Report a vulnerability" on the repository's Security tab).
...
- TAX version (`tax --version`) and affected component (Python CLI, FastAPI backend, Mac host, Pi extension, or iOS app).
